...
The DocJacket plugin works **standalone** — paste the server URL, click Allow on the OAuth consent screen, and the 10 read tools work. But several Claude connectors compose with DocJacket to unlock richer workflows. None of these are required.
